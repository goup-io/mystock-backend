...
public final class QRCodePix {
     ...
     * @see pix.QRCodePix#QRCodePix(DadosEnvioPix, String)
     */
     ...
     * @see pix.QRCodePix#QRCodePix(DadosEnvioPix)
     ...
     */
    public static Path tempImgFilePath() {
        try {
    ...
    public String saveAndGetBytesAsBase64(final Path imagePath) {
        byte[] imageBytes = saveAndGetBytes(imagePath);
