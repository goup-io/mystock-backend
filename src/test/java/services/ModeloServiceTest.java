...
public class ModeloServiceTest {
    ...
    void cadastrarNovoModelo() {
        ...
        ModeloReq modeloReq = new ModeloReq("Modelo", 1, 1);
        Modelo modeloSalvo = new Modelo(1, categoria, tipo, "Modelo");
    ...
    void listarModelosPorFiltro() {
        Categoria categoria = new Categoria(1, "Categoria");
        Tipo tipo = new Tipo(1, "Tipo");
        List<Modelo> listaEsperada = List.of(new Modelo(1, categoria, tipo, "Modelo1"));
        when(repository.findAllByFiltro(anyString(), anyString(), anyString())).thenReturn(listaEsperada);

        List<ModeloRes> resposta = service.listarPorFiltro("Categoria", "Tipo", "Modelo1");
    ...
    void buscarModeloPorIdExistente() {
        Categoria categoria = new Categoria(1, "Categoria");
        Tipo tipo = new Tipo(1, "Tipo");
        Modelo modeloEsperado = new Modelo(1, categoria, tipo, "Modelo");
    ...
    void atualizarModeloExistente() {
        Categoria categoria = new Categoria(1, "Categoria");
        Tipo tipo = new Tipo(1, "Tipo");
        Modelo modeloExistente = new Modelo(1, categoria, tipo, "Modelo");
        ModeloReq modeloAtualizadoReq = new ModeloReq("Modelo Atualizado", 1, 1);
        Modelo modeloAtualizado = new Modelo(1, categoria, tipo, "Modelo Atualizado");
